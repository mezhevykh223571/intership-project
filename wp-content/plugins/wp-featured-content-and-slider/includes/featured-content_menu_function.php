...
function add_wpfcas_page()
    {
       add_submenu_page( 'edit.php?post_type=featured_post', 'Our Members Content Designs', 'Designs', 'manage_options', 'wpfcas-submenu-page', 'wpfcas_page_callback' );
...
function wpfcas_page_callback() {	
	...
	$result ='<div class="wrap"><div id="icon-tools" class="icon32"></div><h2>Featured Content Designs</h2></div>	
				...
				<div class="medium-6 wpcolumns"><div class="postdesigns"><img  src="'.plugin_dir_url( __FILE__ ).'designs/design-4.jpg"><p><code>[featured-content grid="2" design="design-5"] and [featured-content-slider design="design-5"]</code></p></div></div>';
